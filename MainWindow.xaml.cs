...
namespace CanaryLauncherUpdate
{
	...
	public partial class MainWindow : Window
	{
		...
		private void TibiaLauncher_Load(object sender, RoutedEventArgs e)
		{
			...
			if (Directory.Exists(path + "/Molten"))
			{
				clientDownloaded = true;
			}

			if (File.Exists(path + "/Molten/version.txt"))
			{
				StreamReader reader = new StreamReader(path + "/Molten/version.txt");
		...
		{
			string json = path + "/Molten/package.json";
		...
		private void buttonPlay_Click(object sender, RoutedEventArgs e)
		{
			...
			else
			{
				...
				{
					Process.Start(path + "/Molten/bin/" + clientName);
					this.Close();
				}
				else
				{
